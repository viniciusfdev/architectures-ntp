...
var entrypoints = __importStar(require("./data"));
var config_1 = require("./config");
var nanoid_1 = require("nanoid");
var errors_1 = require("../utils/errors");
var Database = /** @class */ (function () {
    function Database(identityContext, config) {
        ...
        get: function () {
            ...
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.identityContext.initialize()];
                        case 1:
                            _a.sent();
                            code = this.identityContext.code;
                            return [4 /*yield*/, this.config.getConfiguration(code)];
                        case 2:
                            config = _a.sent();
                            ...
                            if (data) {
                                ...
                                reject(new errors_1.AppError(409, "The user request don't have a valid identity context"));
                            }
                            return [2 /*return*/];
                    }
                });
    ...
    Database = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)('IdentityContext')),
        __param(1, (0, tsyringe_1.inject)('Config')),
        __metadata("design:paramtypes", [identity_context_1.IdentityContext,
            config_1.Config])
    ], Database);
    return Database;
}());
