...
exports.PublicRoutes = Object.freeze(['login', 'logout']);
...
var authModel_1 = __importDefault(__webpack_require__(/*! ../models/authModel */ "./src/models/authModel.ts"));
var request_context_1 = __webpack_require__(/*! ./request.context */ "./src/context/request.context.ts");
var IdentityContext = /** @class */ (function () {
    function IdentityContext(requestContext) {
        this.requestContext = requestContext;
        if (this.requestContext.public !== true) {
            var payload = authModel_1.default.verifySession(this.requestContext.accessToken);
    ...
    IdentityContext = __decorate([
        ...
        __param(0, (0, tsyringe_1.inject)('RequestContext')),
        __metadata("design:paramtypes", [typeof (_a = typeof request_context_1.RequestContext !== "undefined" && request_context_1.RequestContext) === "function" ? _a : Object])
    ], IdentityContext);
...
var routes_1 = __webpack_require__(/*! ../assets/routes */ "./src/assets/routes.ts");
var RequestContext = /** @class */ (function () {
    function RequestContext(event) {
        this.accessToken = (event.headers.Authorization || '').split(' ')[1];
        this.public = routes_1.PublicRoutes.includes(event.path);
...
var request_context_1 = __webpack_require__(/*! ../context/request.context */ "./src/context/request.context.ts");
var api_1 = __webpack_require__(/*! ../utils/api */ "./src/utils/api.ts");
var container_1 = __importDefault(__webpack_require__(/*! ../utils/container */ "./src/utils/container.ts"));
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var requestContext, identityContext;
    return __generator(this, function (_a) {
        try {
            requestContext = new request_context_1.RequestContext(event);
            ...
            console.log(error);
            return [2 /*return*/, (0, api_1.Response)({ data: error, statusCode: 500 })];
        }
        return [2 /*return*/];
    });
}); };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var jsonwebtoken_1 = __importDefault(__webpack_require__(/*! jsonwebtoken */ "./node_modules/jsonwebtoken/index.js"));
var AuthModel = /** @class */ (function () {
    function AuthModel() {
    }
    AuthModel.issueSession = function (sub, name, code) {
        return jsonwebtoken_1.default.sign({ sub: sub, name: name, code: code }, AuthModel.secret);
    };
    AuthModel.verifySession = function (token) {
        return jsonwebtoken_1.default.verify(token, AuthModel.secret);
    };
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tsyringe_1 = __webpack_require__(/*! tsyringe */ "./node_modules/tsyringe/dist/esm5/index.js");
var database_1 = __importDefault(__webpack_require__(/*! ../repository/database */ "./src/repository/database.ts"));
var PostModel = /** @class */ (function () {
    ...
    PostModel.prototype.create = function (post) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.database.create('Posts', post)];
    ...
    PostModel.prototype.updatePost = function (postId, post) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    PostModel = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof database_1.default !== "undefined" && database_1.default) === "function" ? _a : Object])
    ], PostModel);
    return PostModel;
}());
...
var nanoid_1 = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.cjs");
var tsyringe_1 = __webpack_require__(/*! tsyringe */ "./node_modules/tsyringe/dist/esm5/index.js");
var request_context_1 = __webpack_require__(/*! ../context/request.context */ "./src/context/request.context.ts");
var Connection = /** @class */ (function () {
    function Connection(requestContext) {
        this.requestContext = requestContext;
    }
    var _a;
...
var Database = /** @class */ (function () {
    ...
    Database.prototype.create = function (collection, data) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.connection.data[collection][id] = __assign(__assign({ id: id }, data), { createdAt: new Date() });
                return [2 /*return*/, id];
            });
        });
    };
    Database.prototype.retrieve = function (collection, query) {
        return __awaiter(this, void 0, Promise, function () {
            var results, _i, _a, d, match, _b, _c, _d, attribute, value;
            return __generator(this, function (_e) {
                results = [];
                if (!this.connection.data[collection]) {
                    throw Error('Invalid collection');
                }
                for (_i = 0, _a = Object.values(this.connection.data[collection]); _i < _a.length; _i++) {
                    d = _a[_i];
                    match = true;
    ...
    Database.prototype.update = function (collection, id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                this.connection.data[collection][id] = __assign(__assign({}, this.connection.data[collection][id]), data);
                return [2 /*return*/, id];
            });
        });
    };
    Database.prototype.delete = function (collection, id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                for (_id in this.connection.data[collection]) {
                    if (_id === id) {
                        delete this.connection.data[collection][_id];
                        break;
                    }
                }
                return [2 /*return*/];
    ...
    Database = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)('Connection')),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var tsyringe_1 = __webpack_require__(/*! tsyringe */ "./node_modules/tsyringe/dist/esm5/index.js");
var identity_context_1 = __webpack_require__(/*! ../context/identity.context */ "./src/context/identity.context.ts");
var request_context_1 = __webpack_require__(/*! ../context/request.context */ "./src/context/request.context.ts");
var authModel_1 = __importDefault(__webpack_require__(/*! ../models/authModel */ "./src/models/authModel.ts"));
var postModel_1 = __importDefault(__webpack_require__(/*! ../models/postModel */ "./src/models/postModel.ts"));
var userModel_1 = __importDefault(__webpack_require__(/*! ../models/userModel */ "./src/models/userModel.ts"));
var config_1 = __webpack_require__(/*! ../repository/config */ "./src/repository/config.ts");
var database_1 = __importDefault(__webpack_require__(/*! ../repository/database */ "./src/repository/database.ts"));
...
tsyringe_1.container.register('RequestContext', request_context_1.RequestContext);
...
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tslib */ "./node_modules/tsyringe/node_modules/tslib/tslib.es6.js");
...
/* harmony import */ var _interceptors__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./interceptors */ "./node_modules/tsyringe/dist/esm5/interceptors.js");
...
var InternalDependencyContainer = (function () {
    function InternalDependencyContainer(parent) {
        ...
        this.interceptors = new _interceptors__WEBPACK_IMPORTED_MODULE_8__["default"]();
    }
        ...
        if ((0,_providers__WEBPACK_IMPORTED_MODULE_0__.isTokenProvider)(provider)) {
            ...
            while (tokenProvider != null) {
                ...
                if (path.includes(currentToken)) {
                    throw new Error("Token registration cycle detected! " + (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__spread)(path, [currentToken]).join(" -> "));
                }
    ...
    InternalDependencyContainer.prototype.executePreResolutionInterceptor = function (token, resolutionType) {
        ...
        if (this.interceptors.preResolution.has(token)) {
            ...
            try {
                for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__values)(this.interceptors.preResolution.getAll(token)), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    InternalDependencyContainer.prototype.executePostResolutionInterceptor = function (token, result, resolutionType) {
        ...
        if (this.interceptors.postResolution.has(token)) {
            var remainingInterceptors = [];
            try {
                for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__values)(this.interceptors.postResolution.getAll(token)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var interceptor = _c.value;
                    if (interceptor.options.frequency != "Once") {
                        remainingInterceptors.push(interceptor);
                    }
    ...
    InternalDependencyContainer.prototype.clearInstances = function () {
        var e_3, _a;
        try {
            for (var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__values)(this._registry.entries()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__read)(_c.value, 2), token = _d[0], registrations = _d[1];
    ...
    InternalDependencyContainer.prototype.construct = function (ctor, context) {
        ...
        return new (ctor.bind.apply(ctor, (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__spread)([void 0], params)))();
    };
                ...
                if ((0,_providers_injection_token__WEBPACK_IMPORTED_MODULE_2__.isTokenDescriptor)(param)) {
                    if ((0,_providers_injection_token__WEBPACK_IMPORTED_MODULE_2__.isTransformDescriptor)(param)) {
                        return param.multiple
                            ? (_a = _this.resolve(param.transform)).transform.apply(_a, (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__spread)([_this.resolveAll(param.token)], param.transformArgs)) : (_b = _this.resolve(param.transform)).transform.apply(_b, (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__spread)([_this.resolve(param.token, context)], param.transformArgs));
                    }
                    else {
                        return param.multiple
                    ...
                    return (_c = _this.resolve(param.transform, context)).transform.apply(_c, (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__spread)([_this.resolve(param.token, context)], param.transformArgs));
                }
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/controllers/controller.ts");
